  ...
  cards: [
    {
      ...
      art: `
        ...
        <path d="M124 52 q-4 -14 10 -16 q8 -8 16 0 q14 2 10 16 q2 10 -10 10 q-10 6 -18 -2 q-10 0 -8 -8Z" fill="#d98fa6" stroke="#b06a82" stroke-width="1.6"/>
        <path d="M128 46 q8 -4 12 2 q6 -6 12 0 M130 56 q10 4 20 -2" stroke="#b06a82" stroke-width="1.3" fill="none" stroke-linecap="round"/>
        ...
        <path d="M274 158 q-24 -16 -18 -40 q6 -22 26 -12 q14 8 10 30 q-2 20 -12 24 q-6 2 -6 -2Z" fill="#e0b894" stroke="#a87f52" stroke-width="1.8"/>
        <path d="M272 132 q8 -10 8 4 q0 10 -6 10" stroke="#a87f52" stroke-width="1.6" fill="none"/>
        <path d="M318 166 q40 -16 80 0 q-16 40 -80 0Z" fill="#6e3232" stroke="#4f2424" stroke-width="1.6"/>
        <path d="M354 180 q22 -8 34 0 q-12 14 -34 4Z" fill="#d9748a" stroke="#a84f64" stroke-width="1.4"/>
        <g fill="#fff" stroke="#cfc7b6" stroke-width="0.9">
          <rect x="324" y="160" width="10" height="11" rx="2.5"/><rect x="336" y="158" width="11" height="12" rx="2.5"/>
          <rect x="349" y="157" width="11" height="12" rx="2.5"/><rect x="362" y="157" width="11" height="12" rx="2.5"/>
          <rect x="375" y="158" width="11" height="12" rx="2.5"/><rect x="388" y="160" width="10" height="11" rx="2.5"/>
        </g>
      `,
      zones: [
        ...
        { n: 'কান', item: 'কান', x: 272, y: 134, r: 18, note: 'বাইরের অংশটা শব্দ কুড়িয়ে ভেতরে পাঠায়, পর্দা কাঁপে, তিনটে ছোট হাড় কাঁপুনিটা বাড়িয়ে দেয়। কানের ভেতরের অংশ শরীরের ভারসাম্যও রাখে - তাই বেশি ঘুরলে মাথা ঘোরে।' },
        { n: 'দাঁত', item: 'দাঁত', x: 332, y: 164, r: 16, note: 'শরীরের সবচেয়ে শক্ত জিনিস দাঁতের বাইরের এনামেল - হাড়ের চেয়েও শক্ত। কিন্তু হাড়ের মতো নিজে সারতে পারে না, তাই একবার ক্ষয় হলে সেটা ফিরে আসে না।' },
        { n: 'জিভ', item: 'জিভ', x: 378, y: 184, r: 16, note: 'স্বাদ চেনে, খাবার নাড়ায়, আর কথা বলায় সবচেয়ে বড় কাজটা করে। স্বাদের বড় অংশটা আসলে নাক থেকে আসে - তাই সর্দি হলে খাবারের স্বাদ পাওয়া যায় না।' },
      ],
    },
  ],
};
