...
export const consonants: Letter[] = [
  ...
  { ch: 'ছ', name: 'ছ', roman: 'chhô', word: 'ছাতা', emoji: '☂' },
  { ch: 'জ', name: 'বর্গীয় জ', roman: 'jô', word: 'জাহাজ', emoji: '🚢' },
  { ch: 'ঝ', name: 'ঝ', roman: 'jhô', word: 'ঝর্ণা', emoji: '🏞' },
  ...
  { ch: 'থ', name: 'থ', roman: 'thô', word: 'থালা', emoji: '🍽' },
  ...
  { ch: 'স', name: 'দন্ত্য স', roman: 'sô', word: 'সূর্য', emoji: '☀' },
  { ch: 'হ', name: 'হ', roman: 'hô', word: 'হাতি', emoji: '🐘' },
  { ch: 'ড়', name: 'ড-এ শূন্য ড়', roman: 'ṛô', word: 'গাড়ি', emoji: '🚗', mid: true, note: 'শব্দের শুরুতে বসে না' },
  { ch: 'ঢ়', name: 'ঢ-এ শূন্য ঢ়', roman: 'ṛhô', word: 'আষাঢ়', emoji: '🌧', mid: true, note: 'শব্দের শুরুতে বসে না' },
  { ch: 'য়', name: 'অন্তঃস্থ য়', roman: 'yô', word: 'পায়রা', emoji: '🕊', mid: true, note: 'শব্দের শুরুতে বসে না' },
...
export const kars: Kar[] = [
  { sign: '', name: 'অ (কার নেই)', roman: 'ô', word: 'কলম', emoji: '🖊' },
  ...
  { sign: 'ূ', name: 'দীর্ঘ ঊ-কার', roman: 'ū', word: 'কূপ', emoji: '🕳' },
...
export const conjuncts: Conjunct[] = [
  ...
  { ch: 'দ্ধ', parts: ['দ', 'ধ'], word: 'যুদ্ধ', emoji: '⚔' },
  { ch: 'দ্ব', parts: ['দ', 'ব'], word: 'দ্বীপ', emoji: '🏝' },
  ...
  { ch: 'হ্ম', parts: ['হ', 'ম'], word: 'ব্রহ্মপুত্র', emoji: '🏞' },
  { ch: 'ঞ্চ', parts: ['ঞ', 'চ'], word: 'পঞ্চ', emoji: '🖐' },
  { ch: 'ঞ্জ', parts: ['ঞ', 'জ'], word: 'গঞ্জ', emoji: '🏘' },
