...
const MAP: Record<string, H[]> = {
  ...
  life:      [T('treeparts', undefined, 0.75), T('tree', 'photo', 0.7), T('tree', undefined, 0.15), T('terrain', undefined, 0.5), T('molecule'), T('flock'), T('flock', 'fish'), T('bodyparts', undefined, 0.25)],
