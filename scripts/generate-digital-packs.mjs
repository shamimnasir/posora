...
const htmlForPack = (pack) => {
  ...
  </style><style>.mission-page main{padding-top:18mm}.mission-hero{display:grid;grid-template-columns:42mm 1fr;gap:9mm;align-items:center;margin:10mm 0;padding:7mm;border-radius:8mm;background:linear-gradient(135deg,color-mix(in srgb,var(--accent),#fff 84%),#fff);border:1px solid color-mix(in srgb,var(--accent),#9bb0c0 55%)}.mission-hero b{font-size:16pt}.mission-hero p{font-size:11pt;color:#53657f}.mission-orbit{width:38mm;height:38mm;border-radius:50%;display:grid;place-items:center;position:relative;background:radial-gradient(circle at 35% 30%,#fff,var(--accent));box-shadow:0 4mm 0 color-mix(in srgb,var(--accent),#20304a 35%);color:#fff}.mission-orbit strong{font-size:18pt}.mission-orbit i{position:absolute;left:50%;top:50%;transform:rotate(calc(var(--n)*90deg)) translateY(-18mm) rotate(calc(var(--n)*-90deg));font-style:normal;color:var(--accent2);font-size:15pt}.mission-steps{display:grid;grid-template-columns:repeat(4,1fr);gap:3mm}.mission-steps section{min-height:38mm;padding:4mm 3mm;border-radius:5mm;background:#ffffffd9;border:1px solid #d1dce4;display:flex;flex-direction:column;gap:2mm}.mission-steps i{width:9mm;height:9mm;border-radius:50%;display:grid;place-items:center;background:var(--accent);color:#fff;font-style:normal;font-weight:800}.mission-steps b{font-size:12pt}.mission-steps span{font-size:9pt;color:#53657f}.mission-code{display:flex;align-items:center;gap:5mm;margin-top:8mm;padding:4mm 5mm;border-radius:5mm;background:#16233d;color:#fff}.mission-code b{margin-right:auto}.mission-code span{display:grid;place-items:center;width:11mm;height:11mm;border:1px solid #fff;border-radius:3mm;color:var(--accent)}
